        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultTrackingType = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExercisePool_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "ExerciseTypes",
                columns: new[] { "Id", "DefaultTrackingType", "Name", "OwnerUserId" },
                values: new object[,]
                {
                    { 1, "Reps", "Push-ups", null },
                    { 2, "Reps", "Pull-ups", null },
                    { 3, "Reps", "Bodyweight Squats", null },
                    { 4, "Reps", "KB Swings", null },
                    { 5, "Reps", "Lunges", null },
                    { 6, "Seconds", "Dead Hang", null },
                    { 7, "Seconds", "Plank", null },
                    { 8, "Seconds", "Wall Sit", null }
                });
